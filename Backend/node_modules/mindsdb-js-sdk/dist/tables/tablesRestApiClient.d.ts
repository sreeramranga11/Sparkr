...
export default class TablesRestApiClient extends TablesApiClient {
     ...
     */
    createTable(name: string, integration: string, select: string): Promise<Table>;
    /**
     ...
     */
    createOrReplaceTable(name: string, integration: string, select: string): Promise<Table>;
    /**
     ...
     */
    deleteTable(name: string, integration: string): Promise<void>;
}
