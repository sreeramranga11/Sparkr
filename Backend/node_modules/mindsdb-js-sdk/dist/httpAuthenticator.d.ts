...
export default class HttpAuthenticator {
     ...
     */
    authenticate(axiosClient: Axios, user: string, password: string, managed?: boolean): Promise<void>;
    /**
     *
     * @param {Axios} axiosClient - Axios instance to use when sending login request.
     ...
     */
    handleReauthentication(axiosClient: Axios, error: any): Promise<boolean>;
}
