...
export default class DatabasesRestApiClient extends DatabasesApiClient {
     ...
     */
    getAllDatabases(): Promise<Array<Database>>;
    /**
     ...
     */
    getDatabase(name: string): Promise<Database | undefined>;
    /**
     ...
     */
    createDatabase(name: string, engine?: string, params?: Record<string, JsonValue>): Promise<Database>;
    /**
