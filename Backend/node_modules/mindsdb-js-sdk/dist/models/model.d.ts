...
declare class Model {
     ...
     */
    constructor(modelsApiClient: ModelsApiClient, name: string, project: string, targetColumn: string, status: string, updateStatus: UpdateStatus, version: number, accuracy?: number, tag?: string, active?: boolean);
    /**
